...
using JobPortal.Services.JobPosterService;
...
namespace JobPortal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IJobPosterService, JobPosterService>();
            services.AddTransient<IAdminFactory, AdminFactory>();
            services.AddTransient<IJobPosterFactory, JobPosterFactory>();
            services.AddTransient<IJobSeekerFactory, JobSeekerFactory>();
